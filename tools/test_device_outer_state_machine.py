...
# The clear lives in prepareDeviceSweeps since Task 10 part 2 split the drive:
# it is the ONE prologue both arms call (driveDeviceSweeps and enqueueDrive),
# so neither can begin a drive holding an older drive's verdict.
_DDS = body_of(BICG_CPP, "bool BICGCMFD::prepareDeviceSweeps", "const int nxyz")
